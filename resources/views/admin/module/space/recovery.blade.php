        ...
        <div class="content-body">
            ...
            <section id="column-selectors">
                <div class="row mb-2">
                    ...
                    <div class="col-lg-6">
                        <form id="adminFilterUrl" action="{{route ('admin.module.space.recoverySearch', ["All Data"]) }}" method="get">@csrf
                            <div class="row justify-content-end">
                                <div class="col-lg-6 form-group">
                                    <input type="text" class="form-control" id="search" placeholder="search by Space name">
                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button" class="btn btn-danger btn-sm btn-icon" title="Recover" 
                                                                    onclick="restoreData('{{ route('admin.module.space.restore', [$data->id]) }}')">
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function(){
            const filterUrl = "{{url ('admin/module/space/recovery/search') }}";
