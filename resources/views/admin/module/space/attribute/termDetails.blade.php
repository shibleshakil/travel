                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route ('admin.module.space.attribute.termList',["id"=>$data->attribute->id]) }}">Attribute : {{$data->attribute->name}}</a></li>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{ route ('admin.module.space.attribute.termUpdate', ['id'=>$data->id]) }}" method="post" enctype="multipart/form-data">@csrf
                                        <div class="form-body">
