                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">Edit Flight</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <section id="column-selectors">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <h4 class="card-title" id="basic-layout-card-center">Edit Flight : {{$data->name}}</h4>
                            </div>
                            <div class="col-md-6 text-right">
                                <a href="{{route ('admin.module.flight.index') }}" class="btn btn-info">Flight List</a>
                            </div>
                        </div>
                        <form action="{{route ('admin.module.flight.update', [$data->id]) }}" method="post" enctype="multipart/form-data" class="form">@csrf
                            @include('admin.module.flight.form')
                        </form>
                    </div>
                </div>
            </section>
