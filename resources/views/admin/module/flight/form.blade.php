        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="form-card-header">
                    <h4 id="basic-layout-card-center">Flight Content</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-lg-12">
                            <label for="name">Flight Title</label>
                            <input type="text" name="name" id="name" class="form-control" placeholder="Name of the Flight"
                            @if($url == 'admin.module.flight.edit') value="{{$data->name}}"@else value="{{old('name')}}" @endif>
                        </div>
                        <div class="form-group col-lg-12">
                            <label for="content">Content</label>
                            <textarea name="content" id="content" class="summernote">@if($url == 'admin.module.flight.edit'){!! nl2br($data->content) !!}@else{!! nl2br(old('content')) !!}@endif</textarea>
                        </div>
                        <div class="form-group col-lg-12">
                            ...
                            @if($url == 'admin.module.flight.edit') value="{{$data->youtube_link}}"@else value="{{old('youtube_link')}}" @endif>
                        </div>
                        <div class="col-md-12 form-group">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody id="Car-faqs">
                                        @if($url == 'admin.module.flight.edit' && (sizeof($data->faqs) > 0))
                                            @php
                                                $psl = 1;
                                            @endphp
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            @if($url == 'admin.module.flight.edit' && $data->feature_image) data-default-file="{{asset ('uploads/images/'. $data->feature_image)}}" @endif />
                        </div>
                        <div class="form-group col-lg-12">
                            <label for="">Gallery Image</label>
                                @if($url == 'admin.module.flight.edit' && $data->galary_image)
                                    <div class="row mb-2">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        @if($url == 'admin.module.flight.edit') value="{{$data->bed}}"@else value="{{old('bed')}}" @endif>
                    </div>
                    <div class="col-md-4 form-group">
                        ...
                        @if($url == 'admin.module.flight.edit') value="{{$data->bathroom}}"@else value="{{old('bathroom')}}" @endif>
                    </div>
                    <div class="col-md-4 form-group">
                        <label for="square">Square</label>
                        <input type="number" name="square" min="0" step="any" id="square" class="form-control phone" placeholder="Ex:150"
                        @if($url == 'admin.module.flight.edit') value="{{$data->square}}"@else value="{{old('square')}}" @endif>
                    </div>
                    <div class="col-md-6 form-group">
                        ...
                        @if($url == 'admin.module.flight.edit') value="{{$data->min_day_before_booking}}"@else value="{{old('min_day_before_booking')}}" @endif>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        @if($url == 'admin.module.flight.edit') value="{{$data->min_day_stay}}"@else value="{{old('min_day_stay')}}" @endif>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="number" name="price" id="price" step="any" min="0" class="form-control phone" placeholder="Flight Price" 
                        @if($url == 'admin.module.flight.edit') value="{{$data->price}}"@else value="{{old('price')}}" @endif>
                    </div>
                    <div class="col-md-6 form-group">
                        <label for="sale_price">Sale Price</label>
                        <input type="number" name="sale_price" id="sale_price" step="any" min="0" class="form-control phone" placeholder="Flight Sale Price" 
                        @if($url == 'admin.module.flight.edit') value="{{$data->sale_price}}"@else value="{{old('sale_price')}}" @endif>
                    ...
                    <div class="col-md-12 form-group">
                        <label>
                            ...
                            @if($url == 'admin.module.flight.edit' && $data->enable_extra_price == 1) checked @endif> Enable extra price
                        </label>
                    </div>
                    <div @if($url == 'admin.module.flight.edit' && $data->enable_extra_price == 1) class="col-md-12 form-group"@else class="col-md-12 form-group d-none" @endif id="extra-price-div">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                ...
                                <tbody id="extra-price">
                                    @if($url == 'admin.module.flight.edit' && (sizeof($data->extra_price) > 0))
                                        @php
                                            $xp = 1;
                                        @endphp
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        <select name="location_id" id="location_id" class="select2 form-control">
                            ...
                            @foreach ($locations as $loc)
                                <option value="{{$loc->id}}" @if($url == 'admin.module.flight.edit' && $data->location_id == $loc->id) selected @endif>
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        @if($url == 'admin.module.flight.edit') value="{{$data->address}}" @else value="{{old('address')}}" @endif>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            @if($url == 'admin.module.flight.edit') value="{{$data->map_lat}}" @else value="{{old('map_lat')}}" @endif>
                        </div>
                        <div class="form-group">
                            ...
                            @if($url == 'admin.module.flight.edit') value="{{$data->map_lng}}" @else value="{{old('map_lng')}}" @endif>
                        </div>
                        <div class="form-group">
                            <label for="map_zoom">Map Zoom</label>
                            <input type="text" name="map_zoom" id="map_zoom" class="form-control"
                            @if($url == 'admin.module.flight.edit') value="{{$data->map_zoom}}" @else value="{{old('map_zoom')}}" @endif>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody id="surrending-education">
                                    @if($url == 'admin.module.flight.edit' && (sizeof($data->education) > 0))
                                        @php
                                            $psl = 1;
                                        @endphp
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody id="surrending-health">
                                    @if($url == 'admin.module.flight.edit' && (sizeof($data->health) > 0))
                                        @php
                                            $psl = 1;
                                        @endphp
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody id="surrending-transportation">
                                    @if($url == 'admin.module.flight.edit' && (sizeof($data->transportation) > 0))
                                        @php
                                            $psl = 1;
                                        @endphp
    ...
    <div class="col-lg-3">
            ...
            <div class="card-body">
                <div class="input-group">
                    <div class="d-inline-block custom-control custom-radio mr-1">
                        ...
                        @if($url == 'admin.module.flight.edit' && $data->status == "Publish") checked @else checked @endif>
                    ...
                    <div class="d-inline-block custom-control custom-radio">
                        ...
                        @if($url == 'admin.module.flight.edit' && $data->status == "Draft") checked @endif>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <label>
                        ...
                        @if($url == 'admin.module.flight.edit' && $data->is_feature == 1) checked @endif> Enable featured
                    </label>
                </div>
                <div class="form-group">
                    ...
                    <select name="default_state" id="default_state" class="select form-control">
                        ...
                        <option value="1" @if($url == 'admin.module.flight.edit' && $data->default_state == 1) selected @endif>Always available</option>
                        <option value="0" @if($url == 'admin.module.flight.edit' && $data->default_state == 0) selected @endif>Only available on specific dates</option>
                    </select>
                </div>
            </div>
        </div>
                        ...
                        <div class="attribute-terms">
                            @foreach ($attributeTerm->where('attribute_id', $attr->id) as $attrTrm)
                                <fieldset class="checkbox">
                                    <label>
                                        <input type="checkbox" name="term_id[]" value="{{$attrTrm->id}}" @if($url == 'admin.module.flight.edit' && in_array($attrTrm->id, $flightTerms)) checked @endif> {{$attrTrm->name}}
                                    </label>
                                </fieldset>
                            @endforeach
                        </div>
        ...
        <div class="card">
            <div class="card-body text-center">
                <button type="submit" id="submitBtn" class="btn btn-primary btn-md px-5"> <i class="fa fa-save"></i> @if($url == 'admin.module.flight.edit') Save Changes @else Save @endif </button>
            </div>
        </div>
    </div>
</div>