                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">Edit Car</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <section id="column-selectors">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <h4 class="card-title" id="basic-layout-card-center">Edit Car : {{$data->name}}</h4>
                            </div>
                            <div class="col-md-6 text-right">
                                <a href="{{route ('admin.module.car.index') }}" class="btn btn-info">Car List</a>
                            </div>
                        </div>
                        <form action="{{route ('admin.module.car.update', [$data->id]) }}" method="post" enctype="multipart/form-data" class="form">@csrf
                            @include('admin.module.car.form')
                        </form>
                    </div>
                </div>
            </section>
...
@section('script')
    <script type="text/javascript">
        ...
        function addspec(addP) {
            ...
            var newspecSec = '<tr id="Car-spec-content_'+specCount+'">'+
                '<td>'+
            ...
            $("#Car-spec").append(newspecSec);

        }

        function deletespec(delP) {
            var targetNo = $(delP).attr('data-count');
            var targetspec = $("#Car-spec-content_"+targetNo).remove();
        }
