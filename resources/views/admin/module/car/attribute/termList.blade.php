                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route ('admin.module.car.attribute.termList',["id"=>$attributeInfo->id]) }}">Attribute : {{$attributeInfo->name}}</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            <form class="form" action="{{ route ('admin.module.car.attribute.termStore') }}" method="post" enctype="multipart/form-data">@csrf
                                                <div class="form-body">
                                                        ...
                                                        @if (sizeof ($datas) > 0)
                                                            @foreach ($datas as $data)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="{{ route ('admin.module.car.attribute.termEdit', ['id'=>$data->id])}}">
                                                                            <button type="button" title="Edit" class="btn btn-primary btn-sm">
                                                                            <i class="fa fa-pencil-square"></i> Edit</button>
                                                                        </a>
                                                                        <button type="button" class="btn btn-danger btn-sm" title="Delete" 
                                                                            onclick="deleteData('{{ route('admin.module.car.attribute.termDelete', [$data->id]) }}')">
