                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">All Cars</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content-body">
            ...
            <section id="column-selectors">
                <div class="row mb-2">
                    ...
                    <div class="col-lg-6">
                        <form id="adminFilterUrl" action="{{route ('admin.module.car.search', ["All Data"]) }}" method="get">@csrf
                            <div class="row justify-content-end">
                                ...
                                <div class="col-lg-3 form-group">
                                    <a href="{{route ('admin.module.car.create') }}" class="btn btn-info">Create New Car</a>
                                </div>
                            </div>
                        </form>
                    </div>
                                                ...
                                                <?php $count = 1; ?>
                                                    @foreach ($datas as $data)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ route ('admin.module.car.edit', ['id'=>$data->id])}}">
                                                                    <button type="button" title="Edit Car" class="btn btn-primary btn-sm btn-icon">
                                                                    <i class="fa fa-pencil-square"></i></button>
                                                                </a>
                                                                <button type="button" class="btn btn-danger btn-sm btn-icon" title="Delete Car" 
                                                                    onclick="deleteData('{{ route('admin.module.car.delete', [$data->id]) }}')">
