            ...
            <section id="column-selectors">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <h4 class="card-title" id="basic-layout-card-center">Add New Car</h4>
                            </div>
                            <div class="col-md-6 text-right">
                                <a href="{{route ('admin.module.car.index') }}" class="btn btn-info">Car List</a>
                            </div>
                        </div>
                        <form action="{{route ('admin.module.car.store') }}" method="post" enctype="multipart/form-data" class="form">@csrf
