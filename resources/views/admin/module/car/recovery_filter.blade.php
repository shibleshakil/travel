        ...
        <div class="content-body">
            ...
            <section id="column-selectors">
                <div class="row mb-2">
                    ...
                    <div class="col-lg-6">
                        <form id="adminFilterUrl" action="{{route ('admin.module.car.recoverySearch', ["All Data"]) }}" method="get">@csrf
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button" class="btn btn-danger btn-sm btn-icon" title="Recover" 
                                                                    onclick="restoreData('{{ route('admin.module.car.restore', [$data->id]) }}')">
